...
export const UNITS: Record<string, UnitDef> = {
  ...
  mavic: {
    ...
    jammable: true,
    blurb:
      'DJI Mavic 3 with a thermal camera: the standard tactical eye on both sides. It watches from high up: machine guns cannot reach it, only air defense and interceptors can, and it dodges 80% of what they send. Jamming still drops it. Artillery can only fire at what your side can see.',
  },
  interceptor: {
