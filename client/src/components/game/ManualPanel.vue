  ...
  <div id="manual" class="panel">
    ...
    <div id="manualBody">
      ...
      <template v-else-if="tab === 'armies'">
        ...
        <h4>Warehouses, salvage, derricks</h4>
        <p>A town you hold fills its warehouse (2 funds a second, 3.5 after three minutes of unbroken holding, up to 400), shown under its name. Every 40 seconds a truck leaves with the lot for your headquarters: kill it and the money is gone, capture it and it is yours, take the town and you loot half the warehouse on the spot. A destroyed vehicle, gun, or large aircraft leaves a wreck worth a quarter of its cost for two minutes; the first squad or robot of either side to stand on it takes the salvage. A gas derrick beside a well you hold pays 50% more and fuels three more vehicles; a grain silo beside a wheat field doubles what the grain trucks carry and feeds three more squads.</p>
        <h4>The grid</h4>
        <p>Every building except nets and trenches needs power from the grid it stands on. Sources: the headquarters ({{ 30 }}), the city substation (60), a power plant (90), a generator set (20). Buildings link to neighbours within 150 of each other; a pylon carries the line 190 and costs 40. A grid short of supply runs every building on it at the ratio; a grid with no source runs nothing: factories stop, radar sees 30%, EW stations go quiet, hospitals slow. What is left after the buildings charges battery drones, one point each. Cut the enemy's pylons with two FPVs or a shell and everything past the break stalls; the substation and the plant are what the Gerans and missiles want. A generator set beside a lone forward building is the island that needs no line.</p>
        <h4>Repair</h4>
