...
<template>
  <div class="page" style="display: flex; align-items: center; justify-content: center">
    <div class="card" style="width: min(460px, 92vw)">
      ...
      <p class="dim">
        A real-time strategy game on the Kharkiv to Belgorod axis. Play the teaching levels, fight the computer, or
        match against another commander and talk to them while you do.
      </p>
